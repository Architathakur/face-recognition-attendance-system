...
known_faces_dir = st.sidebar.text_input(
    ...
    "/Users/archita/Desktop/Coding/Projects/Face Recognition Attendance System/known_faces"
)
attendance_csv_dir = st.sidebar.text_input(
    "Daily Attendance CSV Folder",
    "/Users/archita/Desktop/Coding/Projects/Face Recognition Attendance System/logs"
)
...
with col1:
    ...
    st.markdown("---")
    st.write("### Contact Me")
    st.write("**Archita Thakur**")
    st.write("✉️ architath27@gmail.com")
